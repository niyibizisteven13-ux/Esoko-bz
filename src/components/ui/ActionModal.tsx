      ...
      {open && (
        <div className="fixed inset-0 z-[250] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg max-h-[calc(100vh-80px)] overflow-y-auto rounded-[2rem] border border-white/10 bg-white shadow-2xl dark:bg-[#111]"
          >
            <div className="flex flex-col p-6">
              ...
              <div className="flex-1 min-h-0 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
